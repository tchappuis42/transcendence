...
const AddAdmin: React.FC<Props> = ({ userInChannel, currentChannel }) => {
	...
	const addAdmin = () => {
		if (socket) {
			socket.emit("addAdmin", currentChannel, selectedUser?.id);
		}
	...
	return (
		<div className='flex justify-between h-1/5'>
			<h1 className='w-2/5 items-center flex'>ajouter un Admin</h1>
			...
			<div className='w-10 lg:w-14 flex '>
				{selectedUser &&
